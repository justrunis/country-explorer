  ...
  return (
    <div className="mt-6 border p-6 rounded-lg shadow-lg bg-white max-w-md mx-auto">
      ...
      <p className="flex items-center gap-2">
        <FiMapPin className="text-red-500" /> <strong>Capital:</strong>{" "}
        {country.capital?.[0]}
      </p>

      <p className="flex items-center gap-2">
        <FiUsers className="text-green-500" /> <strong>Population:</strong>{" "}
      ...
      <p className="flex items-center gap-2">
        <FiGlobe className="text-purple-500" /> <strong>Languages:</strong>{" "}
        {Object.values(country.languages).join(", ")}
      </p>

      <p className="flex items-center gap-2">
        <FiStar className="text-purple-500" /> <strong>Capital:</strong>{" "}
